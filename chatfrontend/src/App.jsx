    ...
    return (
        <>
            <div className="w-screen h-[100dvh] bg-slate-900 flex">
                <div className="hidden p-[1%] h-full bg-slate-950 border-r border-slate-600 w-80 md:flex md:flex-col">
                    <a href="/">
                        <div className="w-full pb-[5%] mb-[1%] flex items-center justify-start gap-3 tracking-widest select-none border-b border-slate-700 box-content" style={{height: '4vh'}}>
                            <img src={collopng} className="h-full" />
                            <div className="ysab leading-none flex flex-col">
                                <div className="clamp-title text-slate-300 font-black lg:leading-none md:leading-none decoration-0" style={{fontSize: 'calc(0.6vw + 0.6vh)'}}>
                                    COLLOCUS
                                </div>
                                <div className="clamp-subtitle mt-1 text-slate-500 block" style={{fontSize: 'calc(0.3vw + 0.3vh)'}}>
