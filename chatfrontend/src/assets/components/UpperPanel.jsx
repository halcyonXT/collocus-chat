...
export default function UpperPanel(props) {
    ...
    if (isMobile) {
        ...
        return (
            <div className={`w-full min-h-8 h-8 bg-slate-950 border-b box-content p-3 border-slate-600 ${props.disabled && "pointer-events-none"}`}>
