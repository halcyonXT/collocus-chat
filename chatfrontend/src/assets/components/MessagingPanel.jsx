...
export default function MessagingPanel(props) {
    ...
    return (
        <div className='flex-1 flex flex-col justify-end h-full'>
            <UpperPanel/>
            <div ref={messagesRef} className='overflow-y-scroll grow w-full p-[3%] md:p-[1%] box-border flex justify-start flex-col pb-0 md:pb-0'>
            ...
            <div className='w-full min-h-[7%] bg-slate-950 border-t border-slate-700 grid place-items-center box-border'>
                <div className='w-[94%] md:w-[98%] h-max h-min-[60%] h-max-[90%] border border-slate-700 rounded-[1vh] box-border my-[0.5%] px-[3%] md:px-[1%] flex justify-start items-center'>
                    <form onSubmit={handleSendMessage} className='form-input grow h-max'>
                        ...
                        onKeyDown={detectKey}
                        style={{fontSize: !isMobile ? 'calc(0.6vw + 0.6vh)' : '1.3rem'}}></textarea>
                    </form>
                    <div className={`landscape:h-[2vw] portrait:h-[3.5vh] duration-200 aspect-square ${messageInput ? "fill-slate-400" : "fill-slate-600"} hover:fill-slate-300 grid place-items-center cursor-pointer`} onClick={handleSendMessage}>
