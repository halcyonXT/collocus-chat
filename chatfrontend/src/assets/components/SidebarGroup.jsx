...
export default function SidebarGroup(props) {
    ...
    return (
        <>
            <div onClick={handleClick} className={`flex my-2 pt-2 duration-100 select-none justify-start items-center box-content h-5 text-[14px] pb-2 fill-slate-300 text-slate-300 hover:fill-slate-100 hover:text-slate-100 ysab font-semibold cursor-pointer`}>
